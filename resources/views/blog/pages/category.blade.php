...
<div class="content">
    ...
    <section class="section-padding">
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f1.jpg') }}" alt="" class="img-fluid w-100">
                </div>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f2.jpg') }}" alt="" class="img-fluid w-100">
                </div>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f8.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f3.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                <h3 class="post-title mt-1"><a href="blog-single.html">The best soft chocolate chip cookies</a></h3>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f4.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                <h3 class="post-title mt-1"><a href="blog-single.html">How to Make the Best Baked Oatmeal</a></h3>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f5.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                <h3 class="post-title mt-1"><a href="blog-single.html">5 ingredient cilantro vinaigrette</a></h3>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f6.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                <h3 class="post-title mt-1"><a href="blog-single.html">5 ingredient cilantro vinaigrette</a></h3>
        ...
        <div class="col-lg-6 col-md-6">
            <article class="post-grid mb-5">
                <div class="post-thumb mb-4">
                    <img src="{{ asset('blog-assets/images/news/f7.jpg') }}" alt="" class="img-fluid w-100">
                </div>
                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                <h3 class="post-title mt-1"><a href="blog-single.html">The best soft chocolate chip cookies</a></h3>
        ...
        <div class="sidebar-widget about mb-5 text-center p-3">
            <div class="about-author">
                <img src="{{ asset('blog-assets/images/author.jpg') }}" alt="" class="img-fluid">
            </div>
            ...
            <img src="{{ asset('blog-assets/images/liammason.png') }}" alt="" class="img-fluid">
        </div>
        ...
        <div class="sidebar-widget mb-5 ">
            ...
            <div class="sidebar-post-item-big">
                <a href="blog-single.html"><img src="{{ asset('blog-assets/images/news/img-1.jpg') }}" alt="" class="img-fluid"></a>
            ...
            <div class="media border-bottom py-3 sidebar-post-item">
                <a href="#"><img class="mr-4" src="{{ asset('blog-assets/images/news/thumb-1.jpg') }}" alt=""></a>
            ...
            <div class="media py-3 sidebar-post-item">
                <a href="#"><img class="mr-4" src="{{ asset('blog-assets/images/news/thumb-2.jpg') }}" alt=""></a>
               <div class="media-body">
                       <span class="text-muted letter-spacing text-uppercase font-sm">September 10, 2019</span>
        ...
        <div class="sidebar-widget sidebar-adv mb-5">
            <a href="#"><img src="{{ asset('blog-assets/images/sidebar-banner3.png') }}" alt="" class="img-fluid w-100"></a>
        </div>
